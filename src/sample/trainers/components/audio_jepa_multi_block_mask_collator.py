...
class AudioJEPAMultiBlockMaskCollator:
    """Audio-JEPA collator for providing boolean mask tensors.
    ...
    def __init__(
        ...
        Args:
            input_sample_size: Num of samples in the input audio.
            patch_sample_size: Size of each patch. It can also be regarded as window_size.
        ...
        self.n_patches = (
            input_sample_size - (self.patch_sample_size - stride)
        ) // stride
